...
<template>
  <div class="relative bottom-0 bg-slate-100">
      ...
      <div class="grid row-gap-10 mb-8 lg:grid-cols-6">
        ...
        <div class="md:max-w-md lg:col-span-2">
          ...
          <form class="flex flex-col mt-4 md:flex-row">
            ...
            <button
              type="submit"
              class="inline-flex items-center justify-center h-12 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
            >
              Subscribe
            </button>
          </form>
